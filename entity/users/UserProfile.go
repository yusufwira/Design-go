...
type UserProfile struct {
	...
	Email1      *string `json:"email1" gorm:"default:null"`
	UpdatedFrom *string `json:"updated_from" gorm:"default:null"`
	UpdatedDate string  `json:"updated_date" gorm:"autoUpdateTime"`
	IsAdmin     *int    `json:"is_admin" gorm:"default:null"`
}
...
func (UserProfileDB) TableName() string {
...
func (t UserProfileRepo) Create(up UserProfileDB) (UserProfileDB, error) {
...
func (t UserProfileRepo) Update(up UserProfileDB) (UserProfileDB, error) {
...
func (t UserProfileRepo) FindProfileUsers(nik string) (UserProfileDB, error) {
	var userProfile UserProfileDB
